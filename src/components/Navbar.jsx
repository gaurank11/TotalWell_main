...
const Navbar = () => {
  ...
  const notifications = [
    { id: 1, text: 'Welcome to TotalWell', time: '5 mins ago' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-28 md:h-24">
            <div onClick={() => navigate('/')} className="flex items-center space-x-3 cursor-pointer group">
              <img src={assets.logo} alt="TotalWell Logo" className="w-14 h-14 object-contain group-hover:scale-105 transition-transform duration-200" />
              <span className="text-2xl font-bold text-green-700 tracking-tight hover:text-green-500 transition-colors">TotalWell</span>
            </div>
          ...
          <div className={`fixed inset-y-0 right-0 w-full max-w-sm bg-white shadow-2xl transition-transform duration-300 transform ${showMenu ? 'translate-x-0' : 'translate-x-full'}`}>
            <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-white">
              <div className="flex items-center space-x-3">
                <img src={assets.logo} alt="TotalWell Logo" className="w-12 h-12 object-contain" />
                <span className="text-xl font-bold text-green-700 tracking-tight hover:text-green-500">TotalWell</span>
              </div>
